...
<!-- EDC \\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-23238\OpenClinicaExtract\Current -->
 ...
 <!-- CRF \\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf -->
...
`r if(is.character(params$data1)){htmltools::a("Adverse Event Report",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\AE 14.pdf)"))}`
...
`r if(is.character(params$data2)){htmltools::a("Adverse Event Report",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\AE 14.pdf)"))}`
...
`r if(is.character(params$data4)){htmltools::a("Device Incident Report",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\DIR 13.pdf)"))}`
```{r Load de, eval = is.character(params$data4)}
# de <- read_sas(gsub("\\\\","/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-23238\OpenClinicaExtract\Current\010\de.sas7bdat)"))
...
str_detect(de$DESPID08,regex("Sensor",ignore_case = T)) & (str_length(de$DESPID15) != median(str_length(de$DESPID15),na.rm = T)) |
# Other
...
`r if(is.character(params$data5)){htmltools::a("Subject Characteristics",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\DM 1.pdf)"))}`
...
`r if(is.character(params$data6)){htmltools::a("Sensor Use",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\su 5.pdf)"))}`

```{r Load du1, eval = is.character(params$data6)}
# du1 <- read_sas(gsub("\\\\","/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-23238\OpenClinicaExtract\Current\010\du1.sas7bdat)"))
...
`r if(is.character(params$data7)){htmltools::a("Sensor Use",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\su 5.pdf)"))}`

```{r Load du2, eval = is.character(params$data7)}
# du2 <- read_sas(gsub("\\\\","/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-23238\OpenClinicaExtract\Current\001\du2.sas7bdat)"))
...
str_length(du2$DUNUM6) != median(str_length(du2$DUNUM6),na.rm = T),] %>%
  select(Subject,`__STUDYEVENTREPEATKEY`,`__ITEMGROUPREPEATKEY`,DUORES8:last_col()) %>%
  {if (params$label) (sjlabelled::label_to_colnames(.)) else .} %>%
...
`r if(is.character(params$data8)){htmltools::a("Sensor Use",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\su 5.pdf)"))}`

```{r Load du3, eval = is.character(params$data8)}
# du3 <- read_sas(gsub("\\\\","/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-23238\OpenClinicaExtract\Current\001\du3.sas7bdat)"))
...
str_detect(du3$DUORES17,regex("Yes",ignore_case = T)) & str_detect(du3$DUCOM,"^$|pattern"),] %>%
  select(Subject,`__STUDYEVENTREPEATKEY`,`__ITEMGROUPREPEATKEY`,DUORES10:last_col()) %>%
  {if (params$label) (sjlabelled::label_to_colnames(.)) else .} %>%
...
`r if(is.character(params$data11)){htmltools::a("Sensor Use",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\su 5.pdf)"))}`

```{r Load du4, eval = is.character(params$data11)}
# du4 <- read_sas(gsub("\\\\","/",r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-23238\OpenClinicaExtract\Current\001\du4.sas7bdat)"))
...
`r if(is.character(params$data12)){htmltools::a("Sensor Use",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\su 5.pdf)"))}`
...
`r if(is.character(params$data13)){htmltools::a("Subject Characteristics",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\DM 1.pdf)"))}`
...
`r if(is.character(params$data14)){htmltools::a("Subject Characteristics",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\DM 1.pdf)"))}`
...
`r if(is.character(params$data9)){htmltools::a("Protocol Deviation Report",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\pd 15.pdf)"))}`
...
`r if(is.character(params$data10)){htmltools::a("Subject Characteristics",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\DM 1.pdf)"))}`
...
`r if(is.character(params$data15)){htmltools::a("Adhesive Log",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\adhesive 6.pdf)"))}`
...
`r if(is.character(params$data16)){htmltools::a("Adhesive Log",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\adhesive 6.pdf)"))}`
...
`r if(is.character(params$data17)){htmltools::a("Adhesive Log",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\adhesive 6.pdf)"))}`
...
`r if(is.character(params$data18)){htmltools::a("Daily Activity Log",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\DAL 7.pdf)"))}`
...
`r if(is.character(params$data19)){htmltools::a("Meal and Activity Log",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\MAL 8.pdf)"))}`
...
`r if(is.character(params$data20)){htmltools::a("Skin Assessment",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\skin 2.pdf)"))}`
...
`r if(is.character(params$data21)){htmltools::a("Skin Assessment",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Sensor Systems\ADC-US-RES-23238_InHouse Sensor\Case Report Forms\pdf\skin 2.pdf)"))}`
